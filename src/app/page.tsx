    ...
    <div className="min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <Image src="/DEETS_logo.png" alt="DEETS" width={180} height={60} className="h-12 w-auto" />
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-3xl text-center">
          <div className="rounded-2xl border bg-card p-12">
            <Image src="/DEETS_logo.png" alt="DEETS" width={240} height={80} className="mx-auto mb-6 h-16 w-auto" />
